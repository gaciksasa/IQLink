...
namespace IQLink.Migrations
{
    ...
    [Migration("20250408102741_AddDeviceSetupTable")]
    partial class AddDeviceSetupTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IQLink.Models.CurrentDeviceStatus", b =>
                {
            ...
            modelBuilder.Entity("IQLink.Models.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IQLink.Models.DeviceSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IQLink.Models.DeviceStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IQLink.Models.DonationsData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IQLink.Models.SystemNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IQLink.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 8, 12, 27, 40, 245, DateTimeKind.Local).AddTicks(4452),
                            Email = "admin@blooddonation.org",
                            FullName = "Administrator",
                            PasswordHash = "$2a$11$gux0zdUuF6J7Q7hF8FIthONzoEbvbTwoXkC1vLXuGI4.AlXbzdZgS",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 4, 8, 12, 27, 40, 442, DateTimeKind.Local).AddTicks(3473),
                            Email = "user@blooddonation.org",
                            FullName = "Regular User",
                            PasswordHash = "$2a$11$k7QtPpV8aRj/6VUTl/QeJumrInW47IFbTen17HKGv5l65Cn6H.0gW",
                            Role = "User",
                            Username = "user"
                        });
                });
